...
data class FontScaling(
    ...
    val increasingUltraSmall: TextUnit = TextUnit(3.25f, TextUnitType.Em),
    ...
    val increasingLarge: TextUnit = TextUnit(4.25f, TextUnitType.Em),
    val increasingExtraLarge: TextUnit = TextUnit(4.5f, TextUnitType.Em),
    val increasingUltraLarge: TextUnit = TextUnit(4.75f, TextUnitType.Em),
)
